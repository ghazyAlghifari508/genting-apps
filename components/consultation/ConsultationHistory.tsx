...
export function ConsultationHistory({ consultations }: ConsultationHistoryProps) {
  return (
    <div id="konsultasi-history" className="rounded-[32px] sm:rounded-[40px] border border-slate-100 dark:border-white/5 bg-white dark:bg-slate-900 p-4 sm:p-6 shadow-sm md:p-8 relative overflow-hidden mt-12 w-full transition-colors duration-300">
