  ...
  return (
    <>
      <Button 
        ...
        className="bg-doccure-yellow hover:bg-[#cbe33a] text-doccure-dark shadow-md rounded-full px-6 transition-all duration-300 transform hover:-translate-y-0.5 font-bold"
        size="sm"
      >
